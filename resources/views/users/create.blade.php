    ...
    <div style="width:70%;display: block;margin-left: auto;margin-right: auto;">
        ...
        <form class="" action="/users" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter username" name="username" value="{{ old('username') }}" style="width:30%">
            ...
            <div class="form-group">
                <label>E-mail</label>
                <input type="email" class="form-control" placeholder="Enter e-mail" name="email" value="{{ old('email') }}" style="width:30%">
                {{ $errors->first('email') }}
            </div><br>
